...
class BookingModel {
  // Field sesuai dengan tabel 'bookings' di DbHelper Anda
  final String doctorName;
  final String specialty;
  final String dateTime; // Disimpan sebagai String
  final double price;
  final int points;
  ...
  BookingModel({
    ...
    this.isActive = 1, // Default aktif saat booking
    this.isCancelled = 0,
    this.isCompleted = 0,
    this.hasRated = 0,
  });
...
class _BookAppointmentDialogState extends State<BookAppointmentDialog> {
  ...
  void _confirmBooking(BuildContext context) async {
    ...
    final newBooking = BookingModel(
      ...
      isActive: 1, // Status default: aktif
      isCancelled: 0,
      isCompleted: 0,
      hasRated: 0,
    );
